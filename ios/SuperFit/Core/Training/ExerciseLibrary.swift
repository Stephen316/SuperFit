...
enum ExerciseLibrary {
    ...
    static let catalog: [Entry] = [
        // MARK: Chest
        Entry("Barbell Bench Press", .barbell, [.chest: 5, .frontDelts: 3, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 3,
                                        .upperChest: 2],
        ...
        Entry("Incline Barbell Press", .barbell, [.upperChest: 5, .chest: 4, .frontDelts: 4,
                                          .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["incline bench", "incline bench press"]),
        Entry("Incline Barbell Press (45°)", .barbell, [.upperChest: 5, .chest: 3, .frontDelts: 4, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2], alias: ["45 degree incline barbell press", "45 incline bench", "high incline barbell press", "45 incline press"]),
        Entry("Incline Barbell Press (60°)", .barbell, [.frontDelts: 5, .upperChest: 4, .chest: 2, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2], alias: ["60 degree incline barbell press", "60 incline bench", "steep incline barbell press", "60 incline press"]),
        ...
        Entry("Close-Grip Bench Press", .barbell, [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4, .chest: 4, .frontDelts: 2],
              alias: ["cgbp", "close grip bench", "narrow grip bench"]),
        Entry("Flat Dumbbell Press", .dumbbell, [.chest: 5, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 3, .frontDelts: 3,
                                         .upperChest: 2],
              alias: ["dumbbell bench press", "db bench", "db press"]),
        Entry("Incline Dumbbell Press", .dumbbell, [.upperChest: 5, .chest: 4, .frontDelts: 4,
                                            .tricepsLateral: 2, .tricepsLong: 2, .tricepsMedial: 1],
              alias: ["incline db press", "incline dumbbell bench"]),
        Entry("Incline Dumbbell Press (45°)", .dumbbell, [.upperChest: 5, .chest: 3, .frontDelts: 4, .tricepsLateral: 2, .tricepsLong: 2, .tricepsMedial: 1], alias: ["45 degree incline dumbbell press", "45 incline db press", "high incline dumbbell press"]),
        Entry("Incline Dumbbell Press (60°)", .dumbbell, [.frontDelts: 5, .upperChest: 4, .chest: 2, .tricepsLateral: 2, .tricepsLong: 2, .tricepsMedial: 1], alias: ["60 degree incline dumbbell press", "60 incline db press", "steep incline dumbbell press"]),
        Entry("Decline Dumbbell Press", .dumbbell, [.chest: 5, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2, .frontDelts: 2],
        ...
        Entry("Dumbbell Fly", .dumbbell, [.chest: 5, .frontDelts: 1, .upperChest: 1],
        ...
        Entry("Push-Up", .bodyweight, [.chest: 4, .tricepsLateral: 4, .tricepsLong: 4, .tricepsMedial: 3, .upperAbs: 2, .lowerAbs: 2, .frontDelts: 2],
              bodyweight: 0.65, alias: ["press up", "pushup", "press-up"]),
        Entry("Wide Push-Up", .bodyweight, [.chest: 4, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2, .frontDelts: 2, .upperAbs: 2, .lowerAbs: 2], bodyweight: 0.65, alias: ["wide push up", "wide grip push up", "wide hand push up", "wide pushup"]),
        ...
        Entry("Incline Machine Chest Press", .machine,
              [.upperChest: 5, .chest: 3, .frontDelts: 4,
               .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["incline chest press machine", "machine incline press",
                      "plate loaded incline chest press", "low incline machine press"]),
        Entry("Decline Machine Chest Press", .machine,
              [.chest: 5, .tricepsLateral: 3, .tricepsLong: 3,
               .tricepsMedial: 2, .frontDelts: 1],
              alias: ["decline chest press machine", "machine decline press",
                      "plate loaded decline chest press"]),
        Entry("Neutral-Grip Machine Chest Press", .machine,
              [.chest: 5, .upperChest: 3, .tricepsLateral: 4,
               .tricepsLong: 4, .tricepsMedial: 3, .frontDelts: 2],
              alias: ["neutral grip chest press machine", "parallel grip chest press",
                      "neutral machine press"]),
        Entry("Converging Machine Chest Press", .machine,
              [.chest: 5, .upperChest: 2, .frontDelts: 2,
               .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["converging chest press", "convergent chest press",
                      "iso lateral chest press"]),
        Entry("Incline Smith Machine Press", .machine,
              [.upperChest: 5, .chest: 3, .frontDelts: 4,
               .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["smith incline press", "smith incline bench",
                      "incline smith bench press"]),
        Entry("Incline Smith Machine Press (45°)", .machine, [.upperChest: 5, .chest: 3, .frontDelts: 4, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2], alias: ["45 degree incline smith press", "45 incline smith machine", "high incline smith press"]),
        Entry("Incline Smith Machine Press (60°)", .machine, [.frontDelts: 5, .upperChest: 4, .chest: 2, .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2], alias: ["60 degree incline smith press", "60 incline smith machine", "steep incline smith press"]),
        Entry("Decline Smith Machine Press", .machine,
              [.chest: 5, .tricepsLateral: 3, .tricepsLong: 3,
               .tricepsMedial: 2, .frontDelts: 1],
              alias: ["smith decline press", "smith decline bench",
                      "decline smith bench press"]),
        Entry("Machine Dip", .machine,
              [.tricepsLateral: 5, .tricepsLong: 5, .tricepsMedial: 4,
               .chest: 4, .frontDelts: 2],
              alias: ["seated dip machine", "leverage dip", "plate loaded dip"]),
        Entry("Assisted Dip", .machine,
              [.chest: 4, .tricepsLateral: 4, .tricepsLong: 4,
               .tricepsMedial: 3, .frontDelts: 2],
              alias: ["assisted chest dip", "assisted parallel bar dip",
                      "machine assisted dip"]),
        Entry("High-to-Low Cable Fly", .cable,
              [.chest: 5, .upperChest: 1, .frontDelts: 1],
              alias: ["decline cable fly", "high cable crossover",
                      "lower chest cable fly"]),
        Entry("Barbell Floor Press", .barbell,
              [.tricepsLateral: 4, .tricepsLong: 4, .tricepsMedial: 3,
               .chest: 4, .frontDelts: 2],
              alias: ["floor press", "bb floor press"]),
        ...
        Entry("Arnold Press", .dumbbell, [.frontDelts: 5, .sideDelts: 4, .tricepsLateral: 2, .tricepsLong: 2, .tricepsMedial: 1],
        ...
        Entry("Face Pull", .cable, [.rearDelts: 4, .rhomboids: 3, .middleTraps: 3, .upperTraps: 2, .lowerTraps: 2],
              alias: ["cable face pull", "rope face pull"]),
        Entry("Front Raise", .dumbbell, [.frontDelts: 4, .upperChest: 2],
        ...
        Entry("Smith Machine Shoulder Press", .machine,
              [.frontDelts: 5, .sideDelts: 3, .tricepsLateral: 3,
               .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["smith overhead press", "smith machine overhead press",
                      "smith shoulder press"]),
        Entry("Reclined Machine Shoulder Press", .machine,
              [.frontDelts: 5, .sideDelts: 3, .upperChest: 2,
               .tricepsLateral: 3, .tricepsLong: 3, .tricepsMedial: 2],
              alias: ["leverage reclined shoulder press",
                      "reclined shoulder press machine"]),
        Entry("Single-Arm Machine Shoulder Press", .machine,
              [.frontDelts: 5, .sideDelts: 3, .tricepsLateral: 3,
               .tricepsLong: 3, .tricepsMedial: 2, .obliques: 1],
              alias: ["unilateral machine shoulder press",
                      "one arm shoulder press machine"]),
        Entry("Standing Dumbbell Press", .dumbbell,
              [.frontDelts: 5, .sideDelts: 3, .tricepsLateral: 3,
               .tricepsLong: 3, .tricepsMedial: 2, .upperAbs: 2,
               .lowerAbs: 2],
              alias: ["standing db shoulder press", "dumbbell overhead press"]),
        Entry("Lean-Away Cable Lateral Raise", .cable,
              [.sideDelts: 5, .upperTraps: 1],
              alias: ["leaning cable lateral raise", "leaning side raise"]),
        Entry("Cable Y-Raise", .cable,
              [.lowerTraps: 4, .sideDelts: 4, .serratus: 3,
               .upperTraps: 2, .frontDelts: 1],
              alias: ["cable incline y raise", "cable trap 3 raise"]),
        Entry("Lu Raise", .dumbbell,
              [.sideDelts: 5, .upperTraps: 3, .lowerTraps: 2,
               .frontDelts: 2],
              alias: ["dumbbell lu raise", "full range lateral raise"]),
        ...
        Entry("Pull-Up", .bodyweight, [.lats: 5, .biceps: 3, .rhomboids: 3, .middleTraps: 3, .lowerTraps: 2, .wristFlexors: 2, .brachioradialis: 1, .upperAbs: 1, .lowerAbs: 1],
              bodyweight: 1.0, alias: ["pullup", "wide grip pull up", "pull ups"]),
        Entry("Chin-Up", .bodyweight, [.biceps: 4, .lats: 5, .rhomboids: 3, .middleTraps: 3, .wristFlexors: 2, .brachioradialis: 1],
        ...
        Entry("Neutral-Grip Pull-Up", .bodyweight, [.lats: 5, .biceps: 3, .rhomboids: 3, .middleTraps: 3, 
                                            .wristFlexors: 2, .brachioradialis: 2],
        ...
        Entry("Straight-Arm Pulldown", .cable, [.lats: 4, .tricepsLong: 1],
              alias: ["lat pullover cable", "stiff arm pulldown", "lat prayer"]),
        Entry("Dumbbell Pullover", .dumbbell, [.lats: 4, .serratus: 4, .chest: 3, .tricepsLong: 2],
              alias: ["db pullover", "pullover"]),
        Entry("Barbell Shrug", .barbell, [.upperTraps: 5, .middleTraps: 3, .lowerTraps: 3, .wristFlexors: 2, .brachioradialis: 1],
              alias: ["shrug", "bb shrug"]),
        Entry("Dumbbell Shrug", .dumbbell, [.upperTraps: 5, .middleTraps: 3, .lowerTraps: 3, .wristFlexors: 2, .brachioradialis: 1],
              alias: ["db shrug"]),
        Entry("Back Extension", .bodyweight, [.erectorSpinae: 5, .gluteusMaximus: 3, .gluteusMedius: 1, .bicepsFemoris: 3, .semitendinosus: 3],
              bodyweight: 0.45,
        ...
        Entry("Reverse Hyperextension", .machine,
              ...
              alias: ["reverse hyper"]),
        Entry("Machine High Row", .machine,
              [.lats: 5, .rhomboids: 4, .middleTraps: 4, .rearDelts: 3,
               .biceps: 3, .upperTraps: 2, .lowerTraps: 2],
              alias: ["plate loaded high row", "iso lateral high row",
                      "leverage high row"]),
        Entry("Machine Low Row", .machine,
              [.lats: 5, .rhomboids: 4, .middleTraps: 4, .biceps: 3,
               .rearDelts: 2],
              alias: ["plate loaded low row", "iso lateral low row",
                      "leverage low row"]),
        Entry("Neutral-Grip Machine Row", .machine,
              [.lats: 5, .rhomboids: 4, .middleTraps: 4, .biceps: 3,
               .brachioradialis: 1],
              alias: ["close grip machine row", "parallel grip machine row",
                      "neutral machine row"]),
        Entry("Wide-Grip Machine Row", .machine,
              [.rhomboids: 5, .middleTraps: 5, .rearDelts: 4, .lats: 3,
               .biceps: 2, .upperTraps: 2, .lowerTraps: 2],
              alias: ["pronated machine row", "elbows out machine row",
                      "wide machine row"]),
        Entry("Chest-Supported T-Bar Row", .machine,
              [.rhomboids: 5, .middleTraps: 5, .lats: 4, .rearDelts: 3,
               .biceps: 3],
              alias: ["machine chest supported t bar row",
                      "chest supported tbar row"]),
        Entry("Smith Machine Row", .machine,
              [.rhomboids: 5, .middleTraps: 5, .lats: 4, .biceps: 3,
               .rearDelts: 2, .erectorSpinae: 2],
              alias: ["smith row", "smith bent over row"]),
        Entry("Neutral-Grip Lat Pulldown", .cable,
              [.lats: 5, .biceps: 3, .rhomboids: 2, .middleTraps: 2,
               .brachioradialis: 1],
              alias: ["neutral grip pulldown", "close neutral pulldown",
                      "mag grip pulldown"]),
        Entry("Plate-Loaded Pulldown", .machine,
              [.lats: 5, .biceps: 3, .rhomboids: 3, .middleTraps: 3,
               .rearDelts: 2],
              alias: ["iso lateral pulldown", "leverage pulldown",
                      "hammer strength pulldown"]),
        Entry("Machine Pullover", .machine,
              [.lats: 5, .serratus: 3, .chest: 2,
               .tricepsLong: 2, .tricepsLateral: 1],
              alias: ["pullover machine", "nautilus pullover"]),
        Entry("Assisted Pull-Up", .machine,
              [.lats: 5, .biceps: 3, .rhomboids: 3, .middleTraps: 3,
               .wristFlexors: 1, .brachioradialis: 1],
              alias: ["machine assisted pull up", "assisted pullup"]),
        ...
        Entry("Hammer Curl", .dumbbell, [.biceps: 4, .wristFlexors: 3, .brachioradialis: 4],
        ...
        Entry("Cable Hammer Curl", .cable, [.biceps: 4, .wristFlexors: 3, .brachioradialis: 4],
              alias: ["rope hammer curl", "rope curl"]),
        Entry("Reverse Curl", .barbell, [.wristExtensors: 4, .brachioradialis: 4, .biceps: 3],
              alias: ["pronated curl", "reverse grip curl"]),
        Entry("Machine Biceps Curl", .machine,
              [.biceps: 5, .wristFlexors: 1],
              alias: ["biceps curl machine", "seated curl machine",
                      "selectorized bicep curl"]),
        Entry("Bayesian Cable Curl", .cable, [.biceps: 5],
              alias: ["behind body cable curl", "facing away cable curl"]),
        Entry("High Cable Curl", .cable, [.biceps: 5],
              alias: ["cable crucifix curl", "double biceps cable curl"]),
        Entry("Zottman Curl", .dumbbell,
              [.biceps: 4, .brachioradialis: 4, .wristExtensors: 3,
               .wristFlexors: 2],
              alias: ["zottman dumbbell curl"]),
        Entry("Cross-Body Hammer Curl", .dumbbell,
              [.brachioradialis: 4, .biceps: 4, .wristFlexors: 3],
              alias: ["cross body curl", "pinwheel curl"]),

        // MARK: Triceps
        Entry("Triceps Pushdown", .cable, [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4],
              alias: ["tricep pushdown", "cable pushdown", "bar pushdown",
                      "tricep extension"]),
        Entry("Rope Triceps Pushdown", .cable, [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4],
              alias: ["rope pushdown", "rope tricep extension"]),
        Entry("Overhead Triceps Extension", .cable, [.tricepsLateral: 4, .tricepsLong: 5, .tricepsMedial: 4],
              alias: ["overhead extension", "cable overhead tricep", "french press"]),
        Entry("Dumbbell Overhead Extension", .dumbbell, [.tricepsLateral: 4, .tricepsLong: 5, .tricepsMedial: 4],
        ...
        Entry("Narrow Push-Up", .bodyweight, [.tricepsLateral: 4, .tricepsLong: 4, .tricepsMedial: 3, .chest: 3, .frontDelts: 2, .upperAbs: 2, .lowerAbs: 2], bodyweight: 0.65, alias: ["narrow push up", "narrow grip push up", "close hand push up", "narrow pushup"]),
        Entry("Machine Triceps Extension", .machine,
              [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4],
              alias: ["seated triceps extension machine",
                      "machine tricep pushdown"]),
        Entry("Overhead Machine Triceps Extension", .machine, [.tricepsLong: 5, .tricepsLateral: 4, .tricepsMedial: 4], alias: ["machine overhead triceps extension", "seated overhead triceps machine", "overhead triceps machine"]),
        Entry("Single-Arm Cable Pushdown", .cable,
              [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4],
              alias: ["unilateral pushdown", "one arm tricep pushdown"]),
        Entry("Cross-Body Cable Triceps Extension", .cable,
              [.tricepsLateral: 5, .tricepsLong: 4, .tricepsMedial: 4],
              alias: ["cross body tricep extension",
                      "single arm cross body extension"]),
        Entry("Single-Arm Overhead Cable Extension", .cable,
              [.tricepsLong: 5, .tricepsLateral: 4, .tricepsMedial: 4],
              alias: ["unilateral overhead triceps extension",
                      "one arm overhead cable tricep"]),
        Entry("JM Press", .barbell,
              [.tricepsLong: 5, .tricepsLateral: 5, .tricepsMedial: 4,
               .chest: 2, .frontDelts: 1],
              alias: ["barbell jm press"]),

        // MARK: Quads
        Entry("Barbell Squat", .barbell, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 4, .gluteusMedius: 2, .adductorLongus: 3, .adductorMagnus: 4, .pectineus: 2, .upperAbs: 2, .lowerAbs: 2,
                                  .erectorSpinae: 2],
              alias: ["back squat", "squat", "high bar squat", "low bar squat"]),
        Entry("Front Squat", .barbell, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .upperAbs: 3, .lowerAbs: 3, .gluteusMaximus: 3, .gluteusMedius: 1, .rhomboids: 2, .middleTraps: 2],
              alias: ["fs", "barbell front squat"]),
        Entry("Smith Machine Squat", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 3, .gluteusMedius: 1, .adductorLongus: 2, .adductorMagnus: 2, .pectineus: 1],
              alias: ["smith squat"]),
        Entry("Box Squat", .barbell, [.gluteusMaximus: 5, .gluteusMedius: 3, .vastusLateralis: 4, .vastusMedialis: 4, .rectusFemoris: 4, .erectorSpinae: 2],
              alias: ["squat to box"]),
        Entry("Leg Press", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 3, .gluteusMedius: 1, .adductorLongus: 2, .adductorMagnus: 2, .pectineus: 1],
              alias: ["45 degree leg press", "horizontal leg press", "seated leg press"]),
        Entry("Single-Leg Press", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 4, .gluteusMedius: 2],
              alias: ["one leg press", "unilateral leg press"]),
        Entry("Hack Squat", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 3, .gluteusMedius: 1],
              alias: ["machine hack squat"]),
        Entry("Pendulum Squat", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 3, .gluteusMedius: 1],
              alias: ["pendulum"]),
        Entry("Belt Squat", .machine, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 3, .gluteusMedius: 1],
        ...
        Entry("Bulgarian Split Squat", .dumbbell, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 4, .gluteusMedius: 2, .adductorLongus: 2, .adductorMagnus: 2, .pectineus: 1, .upperAbs: 1, .lowerAbs: 1],
              bodyweight: 0.85,
              alias: ["rfess", "rear foot elevated split squat", "bulgarians"]),
        Entry("Split Squat", .dumbbell, [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4, .gluteusMaximus: 4, .gluteusMedius: 2],
        ...
        Entry("V-Squat Machine", .machine,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .adductorLongus: 2, .adductorMagnus: 2],
              alias: ["v squat", "leverage squat", "power squat machine"]),
        Entry("Reverse Hack Squat", .machine,
              [.gluteusMaximus: 5, .gluteusMedius: 3,
               .vastusLateralis: 4, .vastusMedialis: 4, .rectusFemoris: 4,
               .adductorLongus: 3, .adductorMagnus: 3, .pectineus: 2,
               .bicepsFemoris: 2, .semitendinosus: 2],
              alias: ["facing hack squat", "reverse hack"]),
        Entry("Safety Bar Squat", .barbell,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 5, .gluteusMedius: 2,
               .upperAbs: 2, .lowerAbs: 2, .erectorSpinae: 2],
              alias: ["ssb squat", "safety squat bar"]),
        Entry("Zercher Squat", .barbell,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .upperAbs: 3, .lowerAbs: 3, .erectorSpinae: 3,
               .biceps: 1],
              alias: ["zercher"]),
        Entry("Heel-Elevated Squat", .barbell,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 3, .gluteusMedius: 1,
               .upperAbs: 2, .lowerAbs: 2],
              alias: ["cyclist squat", "heel elevated back squat",
                      "heels raised squat"]),
        Entry("Pistol Squat", .bodyweight,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 4, .gluteusMedius: 3,
               .upperAbs: 2, .lowerAbs: 2],
              bodyweight: 0.9,
              alias: ["single leg squat", "one leg squat"]),
        Entry("Smith Machine Bulgarian Split Squat", .machine,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 4,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .adductorLongus: 2, .adductorMagnus: 2],
              alias: ["smith bulgarian split squat", "smith rfess"]),
        Entry("Single-Leg Leg Extension", .machine,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 5],
              alias: ["unilateral leg extension", "one leg extension"]),
        Entry("Machine Sissy Squat", .machine,
              [.vastusLateralis: 5, .vastusMedialis: 5, .rectusFemoris: 5],
              alias: ["sissy squat machine", "weighted sissy squat machine"]),
        Entry("Lateral Lunge", .dumbbell,
              [.adductorLongus: 5, .adductorMagnus: 5, .pectineus: 4,
               .gluteusMedius: 4, .gluteusMaximus: 4,
               .vastusLateralis: 4, .vastusMedialis: 4, .rectusFemoris: 4],
              alias: ["side lunge", "dumbbell lateral lunge"]),
        Entry("Reverse Nordic Curl", .bodyweight,
              [.rectusFemoris: 5, .vastusLateralis: 4, .vastusMedialis: 4,
               .upperAbs: 2, .lowerAbs: 2],
              bodyweight: 0.65,
              alias: ["reverse nordic", "quad lean back"]),
        ...
        Entry("Cable Kickback", .cable, [.gluteusMaximus: 5, .gluteusMedius: 2],
        ...
        Entry("Dumbbell Romanian Deadlift", .dumbbell,
              [.bicepsFemoris: 5, .semitendinosus: 5,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .erectorSpinae: 3, .wristFlexors: 2, .brachioradialis: 1],
              alias: ["dumbbell rdl", "db rdl"]),
        Entry("Smith Machine Romanian Deadlift", .machine,
              [.bicepsFemoris: 5, .semitendinosus: 5,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .erectorSpinae: 3],
              alias: ["smith rdl", "smith machine rdl"]),
        Entry("Cable Romanian Deadlift", .cable,
              [.bicepsFemoris: 5, .semitendinosus: 5,
               .gluteusMaximus: 4, .gluteusMedius: 2,
               .erectorSpinae: 2],
              alias: ["cable rdl", "cable bar rdl"]),
        Entry("Kneeling Leg Curl", .machine,
              [.bicepsFemoris: 5, .semitendinosus: 5,
               .gastrocnemius: 1],
              alias: ["kneeling hamstring curl",
                      "plate loaded kneeling leg curl"]),
        Entry("Cable Hamstring Curl", .cable,
              [.bicepsFemoris: 5, .semitendinosus: 5,
               .gastrocnemius: 1],
              alias: ["standing cable leg curl", "cable leg curl"]),
        Entry("Machine Glute Kickback", .machine,
              [.gluteusMaximus: 5, .gluteusMedius: 2,
               .bicepsFemoris: 1, .semitendinosus: 1],
              alias: ["glute kickback machine", "donkey kick machine"]),
        Entry("Cable Hip Abduction", .cable,
              [.gluteusMedius: 5, .gluteusMaximus: 2],
              alias: ["standing cable abduction", "cable leg abduction"]),
        Entry("Cable Hip Adduction", .cable,
              [.adductorLongus: 5, .adductorMagnus: 5, .pectineus: 4],
              alias: ["standing cable adduction", "cable leg adduction"]),

        // MARK: Calves
        Entry("Standing Calf Raise", .machine, [.gastrocnemius: 5, .soleus: 4],
              alias: ["calf raise", "standing calves"]),
        Entry("Seated Calf Raise", .machine, [.soleus: 5, .gastrocnemius: 1],
        ...
        Entry("Donkey Calf Raise", .machine,
              [.gastrocnemius: 5, .soleus: 4],
              alias: ["donkey calves", "bent over calf raise"]),
        Entry("Smith Machine Calf Raise", .machine,
              [.gastrocnemius: 5, .soleus: 4],
              alias: ["smith calf raise", "smith standing calf raise"]),
        Entry("Machine Tibialis Raise", .machine,
              [.tibialisAnterior: 5, .peroneals: 2],
              alias: ["tib raise machine", "tibialis machine"]),
        ...
        Entry("Wrist Curl", .dumbbell, [.wristFlexors: 5, .brachioradialis: 2],
              alias: ["barbell wrist curl", "seated wrist curl"]),
        Entry("Reverse Wrist Curl", .dumbbell, [.wristExtensors: 5, .brachioradialis: 2],
        ...
        Entry("Suitcase Carry", .dumbbell,
              [.obliques: 5, .upperAbs: 4, .lowerAbs: 4,
               .wristFlexors: 4, .brachioradialis: 3,
               .upperTraps: 3, .middleTraps: 2, .lowerTraps: 2],
              alias: ["suitcase walk", "unilateral farmer carry"]),
        ...
        Entry("Side Plank", .bodyweight, [.obliques: 5, .upperAbs: 2, .lowerAbs: 2], bodyweight: 0.0,
              alias: ["lateral plank"]),
        Entry("Cable Crunch", .cable, [.upperAbs: 5, .lowerAbs: 4, .obliques: 2],
              alias: ["kneeling cable crunch", "rope crunch"]),
        Entry("Crunch", .bodyweight, [.upperAbs: 4, .lowerAbs: 3], bodyweight: 0.3,
        ...
        Entry("Hanging Leg Raise", .bodyweight, [.upperAbs: 4, .lowerAbs: 5, .obliques: 2, .wristFlexors: 1, .brachioradialis: 1],
              bodyweight: 0.45,
        ...
        Entry("Cable Front Raise", .cable, [.frontDelts: 4, .upperChest: 2],
        ...
        Entry("Machine Crunch", .machine, [.upperAbs: 5, .lowerAbs: 4, .obliques: 2],
        ...
        Entry("Reverse Crunch", .bodyweight,
              [.lowerAbs: 5, .upperAbs: 4, .obliques: 2], bodyweight: 0.3,
